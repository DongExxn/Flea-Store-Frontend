...
const MyPage = ({ user, settingName, setUser }) => {
  ...
  const changeButtonHandler = () => {
    if (nick === '' && num === '') alert('변경된 정보가 없습니다');
        ...
        <div>
          <div className={style.picOutter}>
              ...
              <img
                ...
                src={
                  localStorage.getItem('authority') === 'ROLE_USER'
                    ? 'https://cdn-icons-png.flaticon.com/512/8227/8227755.png'
                    : 'https://cdn-icons-png.flaticon.com/512/4856/4856934.png'
                }
              />
            </div>
            <div>
            ...
            <div className={style.auth}>
              {localStorage.getItem('authority') === 'ROLE_USER' ? (
                <span className={style.rity}>회원</span>
              ) : localStorage.getItem('authority') === 'ROLE_OWNER' ? (
                <span>판매자</span>
              ) : (
                <span>관리자</span>
              )}
